...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <nav className="fixed top-0 left-0 right-0 bg-white shadow-md z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            <img src="/logo.png" alt="Smart Techno Students" className="w-10 h-10 rounded-lg" />
            <h1 className="text-xl font-bold text-gray-900">Smart Techno</h1>
          </div>
      ...
      {/* ===== HERO SECTION ===== */}
      <div className="mt-20 bg-gradient-to-br from-blue-50 via-purple-50 to-white pt-20 pb-16 px-6">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-4">
                <button className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-lg font-semibold hover:shadow-lg transition text-lg">
                  Enroll Now
                </button>
                <button className="border-2 border-blue-600 text-blue-600 px-8 py-4 rounded-lg font-semibold hover:bg-blue-50 transition text-lg">
                  View Curriculum
                </button>
              </div>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {benefits.map((benefit, i) => (
              <div key={i} className="bg-white p-6 rounded-xl shadow-md text-center hover:shadow-lg transition">
                ...
                <h3 className="text-lg font-bold mb-2">{benefit.text}</h3>
      ...
      <div id="tracks" className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-4">Our Tracks</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {tracks.map((track, i) => (
              <div key={i} className="bg-white border-2 border-gray-200 rounded-2xl p-8 hover:shadow-xl hover:border-blue-400 transition">
                <div className="text-6xl mb-3">{track.icon}</div>
                <h3 className="text-2xl font-bold mb-1">{track.title}</h3>
                <p className="text-blue-600 font-semibold mb-4">{track.subtitle}</p>
                <p className="text-gray-600 mb-6">{track.description}</p>

                <div className="border-t pt-6">
                  <p className="text-sm font-semibold text-gray-700 mb-3">What they learn:</p>
                ...
                <button className="w-full mt-6 bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 rounded-lg font-semibold hover:shadow-lg transition">
                  Explore {track.title}
                </button>
              </div>
            ))}
      ...
      <div id="about" className="py-20 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold mb-12">About Smart Techno Students</h2>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-600">Industry professionals who are passionate about teaching kids</p>
                </div>
                <div>
                  <h4 className="font-bold text-lg mb-2">🛠️ Hands-On Learning</h4>
                  <p className="text-gray-600">Real robots, real coding, real projects - not just theory</p>
                </div>
                <div>
                  <h4 className="font-bold text-lg mb-2">🎓 Certified Programs</h4>
                  <p className="text-gray-600">Structured curriculum with completion certificates</p>
                </div>
                <div>
                  <h4 className="font-bold text-lg mb-2">📊 Progress Tracking</h4>
                  <p className="text-gray-600">Weekly parent updates and project portfolio for every child</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white p-6 rounded-xl border-l-4 border-purple-600">
                  <div className="text-3xl font-bold text-purple-600">4.9/5</div>
                  <p className="text-gray-600">Parent satisfaction rating</p>
                </div>
                <div className="bg-white p-6 rounded-xl border-l-4 border-green-600">
                  <div className="text-3xl font-bold text-green-600">3</div>
                  <p className="text-gray-600">Specialized tracks offered</p>
                </div>
                <div className="bg-white p-6 rounded-xl border-l-4 border-yellow-600">
                  <div className="text-3xl font-bold text-yellow-600">1:6</div>
                  <p className="text-gray-600">Instructor-to-student ratio</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* ===== FAQ SECTION ===== */}
      <div id="faq" className="py-20 px-6 bg-gray-50">
            ...
            {faqs.map((faq, i) => (
              <div key={i} className="bg-white border border-gray-200 rounded-xl overflow-hidden">
                <button
                  ...
                  className="w-full p-6 flex justify-between items-center hover:bg-gray-50 transition text-left"
                >
                  <h3 className="font-bold text-lg text-gray-900">{faq.q}</h3>
                  <span className={`text-2xl transition ${openFAQ === i ? "rotate-180" : ""}`}>▼</span>
                </button>
                {openFAQ === i && (
      ...
      {/* ===== CTA SECTION ===== */}
      <div className="py-20 px-6 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-white text-blue-600 px-10 py-4 rounded-lg font-bold text-lg hover:shadow-lg transition">
              Register Now
            </button>
            <a href="https://wa.me/919999999999" className="bg-green-500 text-white px-10 py-4 rounded-lg font-bold text-lg hover:bg-green-600 transition flex items-center justify-center gap-2">
              💬 Chat on WhatsApp
            </a>
          </div>
        </div>
      ...
      <footer className="bg-gray-900 text-white py-12 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-bold mb-4">Smart Techno Students</h3>
            <p className="text-gray-400 text-sm">Building the tech leaders of tomorrow</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">Email: hello@smarttechno.com</p>
            <p className="text-gray-400 text-sm">Phone: +20 1204633338</p>
          </div>
          <div>
